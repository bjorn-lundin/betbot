...
Public Class TestForm
  ...
  Public Function GetRaceEkipageByStartPos(ByVal raceId As Integer, ByVal startPos As Integer, _
    ...
    Dim dbReader As Npgsql.NpgsqlDataReader = MyBase.ResourceManager.DbConnection.ExecuteSqlCommand(sql)
  ...
  Private Sub GetRaceEkipageByWinnerOdds(ByVal raceId As Integer, ByRef winOdds As Decimal, ByRef finishPlace As Integer)
    ...
    Dim raceLineReader As Npgsql.NpgsqlDataReader = MyBase.ResourceManager.DbConnection.ExecuteSqlCommand(sql)
  ...
  Private Sub RunTest()
    ...
    If checkDataTable.Checked Then
      Dim dTable As DataTable = MyBase.ResourceManager.DbConnection.ExecuteSql(sql)
      ...
      dTable.Dispose()
    Else
      Dim raceReader As Npgsql.NpgsqlDataReader = MyBase.ResourceManager.DbConnection.ExecuteSqlCommand(sql)
  ...
  Private Sub FillTracksComboBox()
    If (Not _ComboIsFilled) Then
      ...
      Dim trackReader As Npgsql.NpgsqlDataReader = MyBase.ResourceManager.DbConnection.ExecuteSqlCommand(sql)
