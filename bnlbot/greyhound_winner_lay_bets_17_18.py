...
class GreyHoundWinnerLayBet1718Bot(BetBot):
    """put bet on games with low odds"""

    def __init__(self, log):
        super(GreyHoundWinnerLayBet1718Bot, self).__init__(log)
############################# end __init__
...
bot = GreyHoundWinnerLayBet1718Bot(alog)
bot.initialize('HOUNDS_WINNER_LAY_BET_17_18')
