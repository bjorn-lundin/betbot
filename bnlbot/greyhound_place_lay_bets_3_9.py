...
class GreyHoundPlaceLayBet39Bot(BetBot):
    """put bet on games with low odds"""


    def __init__(self, log):
        super(GreyHoundPlaceLayBet39Bot, self).__init__(log)
...
bot = GreyHoundPlaceLayBet39Bot(alog)
bot.initialize('HOUNDS_PLACE_LAY_BET_3_9')
