...
package Table_Dryresultsf is
  ...
  Empty_Data : Table_Dryresultsf.Data_Type;
  -- 
  -- Table name as string 
  --
  Table_Dryresultsf_Name : constant String := "DRYRESULTSF";
  Table_Dryresultsf_Set_Name : constant String := "DRYRESULTSF_SET";
  Table_Dryresultsf_Row_Name : constant String := "DRYRESULTSF_ROW";
  -- 
  ...
  package Dryresultsf_List_Pack is new Simple_List_Class(Table_Dryresultsf.Data_Type);

  -- Procedures for DBMS DEF
  -- Primary key
  function Get(Stm : in Sql.Statement_Type) return Table_Dryresultsf.Data_Type;
  --------------------------------------------
  ...
  function Get(Marketid : Integer_4;
                       Selectionid : Integer_4) return Table_Dryresultsf.Data_Type;
  --------------------------------------------
  ...
  procedure Read_All(List  : in out Dryresultsf_List_Pack.List_Type;
                     ...
                     Max   : in     Integer_4 := Integer_4'Last);
  --------------------------------------------
  procedure Delete(Data : in Table_Dryresultsf.Data_Type);
  --------------------------------------------
  procedure Insert(Data : in out Table_Dryresultsf.Data_Type; Keep_Timestamp : in Boolean := False);
  --------------------------------------------
  ...
  procedure Delete_I1_Marketid(Data  : in     Table_Dryresultsf.Data_Type);
  --------------------------------------------
  ...
  procedure Get_Values(Request : in     Request_Type;
                       Data    : in out Table_Dryresultsf.Data_Type);
  --------------------------------------------
  ...
  function To_String(Data : in Table_Dryresultsf.Data_Type) return String;
  ...
  procedure From_Xml(Xml_Filename : in Unbounded_String;
                     A_List       : in out Dryresultsf_List_Pack.List_Type);
