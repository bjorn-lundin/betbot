...
package Table_Dryrunnersf is
  ...
  procedure Get_Values(Request : in     Request_Type;
                       Data    : in out Table_Dryrunnersf.Data_Type);
  --------------------------------------------
  ...
  function To_String(Data : in Table_Dryrunnersf.Data_Type) return String;
  ...
  procedure From_Xml(Xml_Filename : in Unbounded_String;
                     A_List       : in out Dryrunnersf_List_Pack.List_Type);
