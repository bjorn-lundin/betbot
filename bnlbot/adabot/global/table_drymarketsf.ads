...
package Table_Drymarketsf is
  ...
  type Data_Type is record
      ...
      Bspmarket :    String (1..0) := (others => ' ') ; --
      Markettype :    String (1..0) := (others => ' ') ; --
      Eventhierarchy :    String (1..0) := (others => ' ') ; -- non unique index 2
      Lastrefresh :    Time_Type  := Time_Type_First ; --
      Turninginplay :    String (1..0) := (others => ' ') ; --
      Menupath :    String (1..0) := (others => ' ') ; --
      Betdelay :    Integer_4  := 0 ; --
      Exchangeid :    Integer_4  := 0 ; --
      Countrycode :    String (1..0) := (others => ' ') ; --
      Marketname :    String (1..0) := (others => ' ') ; -- non unique index 3
      Marketstatus :    Integer_4  := 0 ; --
  ...
  procedure Get_Values(Request : in     Request_Type;
                       Data    : in out Table_Drymarketsf.Data_Type);
  --------------------------------------------
  ...
  procedure From_Xml(Xml_Filename : in Unbounded_String;
                     A_List       : in out Drymarketsf_List_Pack.List_Type);
