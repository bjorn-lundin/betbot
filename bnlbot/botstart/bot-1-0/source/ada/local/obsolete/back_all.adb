...
procedure Back_All is
  ...
  type Outcome_Type is (Back_Ok, Back_Bad, None);
...
begin
  ...
  AWK.Open (Separators => ",",  
            Filename   => "/home/bnl/bnlbot/botstart/bot-1-0/history/data/untreated/2012_horses.dat");
