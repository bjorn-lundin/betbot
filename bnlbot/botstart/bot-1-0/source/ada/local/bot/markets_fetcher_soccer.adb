...
procedure Markets_Fetcher_Soccer is
  ...
  Data_Pollers : array (1..12) of Poll_Process := (
...
--   none for all countries   
  ...
  Append(Market_Type_Codes , Create("MATCH_ODDS"));                 -- for horses/hounds
  Append(Market_Type_Codes , Create("CORRECT_SCORE"));               -- for horses/hounds
