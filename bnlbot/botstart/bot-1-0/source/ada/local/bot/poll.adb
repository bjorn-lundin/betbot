...
--                    );
  ...
  begin
    case Bettype is
      ...
      when Back_1_20_13_1_2_WIN => return Process_Io.To_Process_Type("bet_placer_002");
      when Back_1_20_10_1_2_WIN => return Process_Io.To_Process_Type("bet_placer_003");
      when Back_1_20_07_1_2_WIN => return Process_Io.To_Process_Type("bet_placer_004");
      when Back_1_10_20_1_2_WIN => return Process_Io.To_Process_Type("bet_placer_005"); 
      when Back_1_10_16_1_2_WIN => return Process_Io.To_Process_Type("bet_placer_006"); 
      when Back_1_10_13_1_2_WIN => return Process_Io.To_Process_Type("bet_placer_007"); 
      when Back_1_10_10_1_2_WIN => return Process_Io.To_Process_Type("bet_placer_008"); 
      when Back_1_10_07_1_2_WIN => return Process_Io.To_Process_Type("bet_placer_009"); 
      when Back_1_10_07_1_2_PLC => return Process_Io.To_Process_Type("bet_placer_010");
      when Lay_160_200          => return Process_Io.To_Process_Type("bet_placer_011");
      when Lay_1_10_25_4        => return Process_Io.To_Process_Type("bet_placer_012");
    end case;
  end Get_Bet_Placer;
