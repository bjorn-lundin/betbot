...
package Table_History2 is
  ...
  type Data_Type is record
      ...
      Fulldescription :    String (1..200) := (others => ' ') ; --
      Course :    String (1..50) := (others => ' ') ; --
      Scheduledoff :    Time_Type  := Time_Type_First ; --
      Event :    String (1..50) := (others => ' ') ; -- non unique index 5
      Selectionid :    Integer_4  := 0 ; -- non unique index 6
      Selection :    String (1..50) := (others => ' ') ; --
      Odds :    Float_8  := 0.0 ; --
      Numberbets :    Integer_4  := 0 ; --
      Volumematched :    Float_8  := 0.0 ; --
      Latesttaken :    Time_Type  := Time_Type_First ; -- non unique index 7
      Firsttaken :    Time_Type  := Time_Type_First ; --
      Winflag :    Boolean  := False ; --
      Inplay :    String (1..2) := (others => ' ') ; --
  end record;
  Empty_Data : Table_History2.Data_Type;
  -- 
  -- Table name as string 
  --
  Table_History2_Name : constant String := "HISTORY2";
  Table_History2_Set_Name : constant String := "HISTORY2_SET";
  Table_History2_Row_Name : constant String := "HISTORY2_ROW";
  -- 
  ...
  package History2_List_Pack is new Simple_List_Class(Table_History2.Data_Type);

  -- Procedures for DBMS DEF
  -- Primary key
  function Get(Stm : in Sql.Statement_Type) return Table_History2.Data_Type;
  --------------------------------------------
  ...
  --------------------------------------------
  function Get(Pk : Integer_4) return Table_History2.Data_Type;
  --------------------------------------------
  ...
  procedure Read_All(List  : in out History2_List_Pack.List_Type;
                     ...
                     Max   : in     Integer_4 := Integer_4'Last);
  --------------------------------------------
  procedure Delete(Data : in Table_History2.Data_Type);
  --------------------------------------------
  procedure Update(Data : in out Table_History2.Data_Type; Keep_Timestamp : in Boolean := False);
  --------------------------------------------
  procedure Insert(Data : in out Table_History2.Data_Type; Keep_Timestamp : in Boolean := False);
  --------------------------------------------
  ...
  function Count_Sportsid(Data : Table_History2.Data_Type) return Integer_4;
  --------------------------------------------


  procedure Delete_Sportsid(Data  : in     Table_History2.Data_Type);
  --------------------------------------------
  ...
  function Count_Eventid(Data : Table_History2.Data_Type) return Integer_4;
  --------------------------------------------


  procedure Delete_Eventid(Data  : in     Table_History2.Data_Type);
  --------------------------------------------
  ...
  function Count_Country(Data : Table_History2.Data_Type) return Integer_4;
  --------------------------------------------


  procedure Delete_Country(Data  : in     Table_History2.Data_Type);
  --------------------------------------------
  ...
  function Count_Event(Data : Table_History2.Data_Type) return Integer_4;
  --------------------------------------------


  procedure Delete_Event(Data  : in     Table_History2.Data_Type);
  --------------------------------------------
  ...
  function Count_Latesttaken(Data : Table_History2.Data_Type) return Integer_4;
  --------------------------------------------


  procedure Delete_Latesttaken(Data  : in     Table_History2.Data_Type);
  --------------------------------------------
  ...
  function Count_Eventid_selectionid_latesttaken(Data : Table_History2.Data_Type) return Integer_4;
  --------------------------------------------


  procedure Delete_Eventid_selectionid_latesttaken(Data  : in     Table_History2.Data_Type);
  --------------------------------------------


  -- Procedures for all DBMS

  function To_String(Data : in Table_History2.Data_Type) return String;
