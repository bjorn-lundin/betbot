...
create table ABETS ( 
  ...
  REFERENCE varchar(30) default ' ' not null , 
  SIZE float default 0.0 not null , 
  PRICE float default 0.0 not null , 
  SIDE varchar(4) default ' ' not null , 
  BETNAME varchar(100) default ' ' not null , -- non unique index 4
  BETWON boolean default False , -- non unique index 5
  ...
  STARTTS timestamp(3) without time zone  , -- non unique index 6
  BETPLACED timestamp(3) without time zone  , -- non unique index 7
  PRICEMATCHED float default 0.0 not null , 
  SIZEMATCHED float default 0.0 not null , 
  RUNNERNAME varchar(50) default ' ' not null , 
  FULLMARKETNAME varchar(50) default ' ' not null , 
  SVNREVISION integer default 1 not null , 
