...
package body Table_Awinners is
  ...
  -- Primary key
  function Get(Stm : in Sql.Statement_Type) return Table_Awinners.Data_Type is
    Data : Table_Awinners.Data_Type;
  begin
...
---------------------------------------------
  ...
  function Get(Marketid : String;
                       Selectionid : Integer_4) return Table_Awinners.Data_Type is
    Data       : Table_Awinners.Data_Type;
...
--------------------------------------------
  ...
  procedure Read_All(List  : in out Awinners_List_Pack.List_Type;
  ...
  begin
    ...
    if Order then
      Sql.Prepare(Stm_Select_All_O, "select * from AWINNERS order by MARKETID, SELECTIONID");
      Read_List(Stm_Select_All_O, List, Max);
    else
      Sql.Prepare(Stm_Select_All, "select * from AWINNERS");
...
--------------------------------------------
  ...
  procedure Read_List(Stm  : in     Sql.Statement_Type;
                      List : in out Awinners_List_Pack.List_Type;
                      Max  : in     Integer_4 := Integer_4'Last) is
    use Sql;
    Count       : Integer_4 := 0;
    Data        : Table_Awinners.Data_Type;
  ...
  begin
    ...
    loop
      ...
      Data := Get(Stm);
      Awinners_List_Pack.Insert_At_Tail(List, Data);
      Count := Count +1;
    end loop;
...
--------------------------------------------
  ...
  procedure Read(Data       : in out Table_Awinners.Data_Type;
  ...
  begin
    if Start_Trans then Sql.Start_Read_Write_Transaction(Transaction); end if;
    Sql.Prepare(Stm_Select, " select * from AWINNERS " & 
...
---------------------------------------------
  ...
  procedure Delete(Data : in Table_Awinners.Data_Type) is
  begin
    Sql.Prepare(Stm_Delete, " delete from AWINNERS " & 
            "where MARKETID=:MARKETID" &
            " and SELECTIONID=:SELECTIONID" ) ;
...
--------------------------------------------
  ...
  procedure Update(Data : in out Table_Awinners.Data_Type; Keep_Timestamp : in Boolean := False) is
    Now     : Sattmate_Calendar.Time_Type := Sattmate_Calendar.Clock;
    Process : Process_Io.Process_Type     := Process_Io.This_Process;
  begin
    Sql.Prepare(Stm_Update, "update AWINNERS set " &
            "IXXLUPD=:IXXLUPD," &
            "IXXLUTS=:IXXLUTS " &
            "where MARKETID=:MARKETID " &
            "and SELECTIONID=:SELECTIONID " ) ;
...
--------------------------------------------
  ...
  procedure Insert(Data : in out Table_Awinners.Data_Type; Keep_Timestamp : in Boolean := False) is
    Now     : Sattmate_Calendar.Time_Type := Sattmate_Calendar.Clock;
    Process : Process_Io.Process_Type     := Process_Io.This_Process;
  begin
    if not Keep_Timestamp then
    ...
    Sql.Prepare(Stm_Insert, "insert into AWINNERS values (" &
            ":MARKETID, " &
            ":SELECTIONID, " &
            ":IXXLUPD, " &
            ":IXXLUTS) " ) ;
...
--------------------------------------------
  ...
  procedure Delete_Withcheck(Data : in Table_Awinners.Data_Type) is
  begin
    Sql.Prepare(Stm_Delete_With_Check, " delete from AWINNERS " & 
            "where MARKETID=:MARKETID" &
            " and SELECTIONID=:SELECTIONID" &
            " and IXXLUPD=:IXXLUPD" &
            " and IXXLUTS=:IXXLUTS" ) ;
...
--------------------------------------------
  ...
  procedure Update_Withcheck(Data : in out Table_Awinners.Data_Type; Keep_Timestamp : in Boolean := False) is
    Now     : Sattmate_Calendar.Time_Type := Sattmate_Calendar.Clock;
    Process : Process_Io.Process_Type     := Process_Io.This_Process;
  begin

    Sql.Prepare(Stm_Update_With_Check, "update AWINNERS set " &
            "IXXLUPD=:IXXLUPD," &
            "IXXLUTS=:IXXLUTS " &
            "where MARKETID=:MARKETID " &
            "and SELECTIONID=:SELECTIONID " &
...
--------------------------------------------
  ...
  procedure Read_I1_Marketid(Data  : in     Table_Awinners.Data_Type;
                       List  : in out Awinners_List_Pack.List_Type;
                       Order : in     Boolean := False;
                       Max   : in     Integer_4 := Integer_4'Last) is
    use Sql;
  ...
  begin
    if (Start_Trans) then Sql.Start_Read_Write_Transaction(Transaction); end if;
    if Order then
      Sql.Prepare(Stm_Select_I1_Marketid_O, " select * from AWINNERS " & 
            "where MARKETID=:MARKETID" &
      ...
      Sql.Prepare(Stm_Select_I1_Marketid, " select * from AWINNERS " & 
            "where MARKETID=:MARKETID" ) ; 
  ...
  procedure Delete_I1_Marketid(Data  : in     Table_Awinners.Data_Type) is
  begin
      Sql.Prepare(Stm_Delete_I1_Marketid, " delete from AWINNERS " & 
            "where MARKETID=:MARKETID" ) ; 
  ...
  function Is_Existing_I1(
    ...
    List       : Awinners_List_Pack.List_Type := Awinners_List_Pack.Create;
  begin
    Data.Marketid := Marketid ; 
    Read_I1_Marketid(Data, List, False, 1);
    Is_Exist := not Awinners_List_Pack.Is_Empty(List);
    Awinners_List_Pack.Release(List);
    return Is_Exist;
  end Is_Existing_I1 ;
  --------------------------------------------
  ...
  procedure Read_Marketid(Data  : in     Table_Awinners.Data_Type;
                       List  : in out Awinners_List_Pack.List_Type;
                       Order : in     Boolean := False;
                       Max   : in     Integer_4 := Integer_4'Last) is
    use Sql;
  ...
  begin
    if Start_Trans then Sql.Start_Read_Write_Transaction(Transaction); end if;
    if Order then
      Sql.Prepare(Stm_Select_Marketid_O, " select * from AWINNERS " & 
            "where MARKETID=:MARKETID" &
            " order by MARKETID, SELECTIONID "  ) ; 
      ...
      Sql.Prepare(Stm_Select_Marketid, " select * from AWINNERS " & 
            "where MARKETID=:MARKETID"  ) ; 
...
---------------------------------------------
  procedure Read_One_Marketid(Data       : in out Table_Awinners.Data_Type;
                           Order      : in     Boolean := False;
                           End_Of_Set : in out Boolean) is
    List : Awinners_List_Pack.List_Type := Awinners_List_Pack.Create;
  begin
    Read_Marketid(Data, List, Order, 1);
    if Awinners_List_Pack.Is_Empty(List) then
      End_Of_Set := True;
    else
      End_Of_Set := False;
      Awinners_List_Pack.Remove_From_Head(List, Data);
    end if;
    Awinners_List_Pack.Release(List);
    end Read_One_Marketid;
---------------------------------------------

  function Count_Marketid(Data : Table_Awinners.Data_Type) return Integer_4 is
    use Sql;
    Count       : Integer_4 := 0;
    End_Of_Set  : Boolean := False;
    Start_Trans : constant Boolean := (Sql.Transaction_Status = Sql.None);
  ...
  begin
    if Start_Trans then Sql.Start_Read_Write_Transaction(Transaction); end if;
    Sql.Prepare(Stm_Select_Count_Marketid, "select count('a') from AWINNERS where MARKETID = :MARKETID ");
...
---------------------------------------------
  procedure Delete_Marketid(Data  : in     Table_Awinners.Data_Type) is
  begin
      Sql.Prepare(Stm_Delete_Marketid, " delete from AWINNERS " & 
            "where MARKETID=:MARKETID"  ) ; 
...
--------------------------------------------
  ...
  function To_String(Data : in Table_Awinners.Data_Type) return String is
  begin
    return
