...
package body GNATCOLL.JSON is
      ...
      case Strm (Idx.all) is
         ...
         when '-' | '0' .. '9' =>
            ...
            begin
               ...
               if Part = Int then
                  return Create (Long_Long_Integer'Value (To_String (Unb)));
               else
   ...
   function Get (Val : JSON_Value; Field : UTF8_String) return Long_Long_Integer is
   begin
      return Get (Get (Val, Field));
   end Get;
