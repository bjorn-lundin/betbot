...
INI_FILE=$BOT_START/user/$BOT_USER/betfair.ini
#echo $INI_FILE
...
INI_BOT_ROOT=$($INI_READER   --ini=$INI_FILE --section=system --variable=bot_root   --default="Not_found")
export BOT_ROOT=$(eval echo $INI_BOT_ROOT)

INI_BOT_CONFIG=$($INI_READER --ini=$INI_FILE --section=system --variable=bot_config --default="Not_found")
export BOT_CONFIG=$(eval echo $INI_BOT_CONFIG)

INI_BOT_TARGET=$($INI_READER --ini=$INI_FILE --section=system --variable=bot_target --default="Not_found")
export BOT_TARGET=$(eval echo $INI_BOT_TARGET)

INI_BOT_SOURCE=$($INI_READER --ini=$INI_FILE --section=system --variable=bot_source --default="Not_found")
export BOT_SOURCE=$(eval echo $INI_BOT_SOURCE)

INI_BOT_SCRIPT=$($INI_READER --ini=$INI_FILE --section=system --variable=bot_script --default="Not_found")
