...
#    self.no_session = True
    ...
    while 1:
        ...
        login_status = api.login_ng(username, password, productid, vendorid)
        if login_status == 'OK':
            conn.send(api.session_token)
            print 'api.session_token', api.session_token
        else :
