...
--            end if;
            ...
            Log ("make_lay_bet - Bet made on " & Table_Dryrunners.To_String (Runner) & " price was"
            & Integer(Runner.Layprice)'Img & " minprice =" & Integer(Min_Price)'Img  & " maxprice =" & Integer(Max_Price)'Img );
            exit;
         end if;
