                           ...
                           loop
                              ...
                              Race.Make_Lay_Bet
                                (Bet_Laid          => Global_Bet_Laid,
                                 ...
                                 Size              => Global_Size,
                                 Min_Price         => Races.Min_Price_Type (Global_Back_Price ),
                                 Max_Price         => Races.Max_Price_Type (Global_Back_Price) + Races.Max_Price_Type(Global_Delta_Price));
                              ...
                              if Global_Bet_Laid then
                                 ...
                                 -- Print ("Race.Price " & integer(Race.Price)'Img);
...
--                        end if; -- min_price < Max_Price108777461
                        ...
                        Print (Integer (Global_Back_Price)'Img & " " &
                             Integer (Global_Delta_Price)'Img & " " &
