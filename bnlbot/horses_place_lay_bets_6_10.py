...
class HorsesPlaceLayBet610Bot(BetBot):
    """put bet on games with low odds"""

    def __init__(self, log):
        super(HorsesPlaceLayBet610Bot, self).__init__(log)
...
bot = HorsesPlaceLayBet610Bot(alog)
bot.initialize('HORSES_PLACE_LAY_BET_6_10')
