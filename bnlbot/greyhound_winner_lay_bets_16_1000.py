...
class GreyHoundWinnerLayBet161000Bot(BetBot):
    """put bet on games with low odds"""

    def __init__(self, log):
        super(GreyHoundWinnerLayBet161000Bot, self).__init__(log)
############################# end __init__
...
bot = GreyHoundWinnerLayBet161000Bot(alog)
bot.initialize('HOUNDS_WINNER_LAY_BET_16_1000')
