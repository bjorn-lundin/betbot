...
class GreyHoundWinnerBackBet3801Bot(BetBot):
    """put bet on games with low odds"""

    def __init__(self, log):
        super(GreyHoundWinnerBackBet3801Bot, self).__init__(log)
...
bot = GreyHoundWinnerBackBet3801Bot(alog)
bot.initialize('HOUNDS_WINNER_BACK_BET_38_01')
