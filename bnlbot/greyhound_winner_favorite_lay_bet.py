...
class GreyHoundWinnerFavoriteLayBetBot(BetBot):
    """put bet on games with low odds"""
    BETTING_SIZE = None
    MAX_ODDS = None
    MIN_ODDS = None
    ...
    def __init__(self, log):
        super(GreyHoundWinnerFavoriteLayBetBot, self).__init__(log)
        ...
        if type(markets) is list:
            ...
            for market in markets[:]:
             ...
             #as we're modifying it on the fly...
                ...
                if market_ok : 
                    market_ok = market['market_name'].lower().find("AvB") == -1 
                if market_ok : 
...
bot = GreyHoundWinnerFavoriteLayBetBot(alog)
bot.initialize('HOUNDS_WINNER_FAVORITE_LAY_BET')
